...
from pdf_extract_kit.pdf_extract_kit.utils.config_loader import load_config, initialize_tasks_and_models
import pdf_extract_kit.pdf_extract_kit.tasks
...
def main(config_path):
    ...
    print("Initialized layout detection task.")
    print(model_layout_detection)
    ...
    # save detection results to a text file in current folder
